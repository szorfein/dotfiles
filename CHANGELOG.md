...
- New config are in `awesome-m3`, themes compatible are now in
  `awesome-m3-themes` folder.
- Add 6 themes in themes-m3 - Focus (new), Lines, Morpho, Miami, Sci, Connected
  (resurrect for green tone).
...
- Vim (and lightline) color schemes are pushed on
  [vamp.vim](https://github.com/szorfein/vamp.vim), based on Dracula (5000+
  lines of codes generated).
- Write a script to generate themes `awm-3/bin/new-theme-m3-maker.sh`, works
  with
  [material-theme-builder](https://material-foundation.github.io/material-theme-builder/).

### Updated

- ZSH now include starship - zsh-syntax-highlighting - zsh-autosuggestion with
  ohmyzsh.
