...
-- fonts
mytheme.f = {
  h1 = (height >= 1024 and "Iosevka Nerd Font Light 56" or "Iosevka Nerd Font Medium 40"), -- used on big icon or big title
  h4 = "Iosevka Nerd Font Regular 30",
